...
if __name__ == "__main__":
        parser = argparse.ArgumentParser(description="Plot size of healthy cells from the given npy file.")
        parser.add_argument("npy_file", type=str, help="Path to the npy file.")
        parser.add_argument("output_dir", type=str, help="Path to save matplotlib figure (.jpg)")
